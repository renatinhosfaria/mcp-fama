...
import { DEFAULT_HTTP_HEADERS_TIMEOUT_MS, DEFAULT_HTTP_KEEP_ALIVE_TIMEOUT_MS, DEFAULT_SHUTDOWN_GRACE_MS, } from './http-server.js';
...
export function loadConfig(environment) {
    ...
    const httpKeepAliveTimeoutMs = positiveInteger(environment, 'HTTP_KEEP_ALIVE_TIMEOUT_MS', DEFAULT_HTTP_KEEP_ALIVE_TIMEOUT_MS);
    const httpHeadersTimeoutMs = positiveInteger(environment, 'HTTP_HEADERS_TIMEOUT_MS', DEFAULT_HTTP_HEADERS_TIMEOUT_MS);
