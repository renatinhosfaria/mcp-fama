...
- `financas`: Controle Financeiro PostgreSQL workflows and financial records.
...
- Treat Meta Ads and finance operations as high-impact: verify account, campaign, date range, amount, and currency before invoking write tools.
