...
const TOOL_REGISTRY: Record<string, ToolDef> = {
  ...
  record_decision:       { schema: wf.RecordDecisionSchema,      handler: wf.recordDecision,      desc: 'Create a write-once decision note', annotations: { openWorldHint: false } },
  append_decision:       { schema: wf.AppendDecisionSchema,      handler: wf.appendDecision,      desc: 'Deprecated: use record_decision', annotations: { openWorldHint: false } },
  ...
  create_or_update_entity: { schema: wf.CreateOrUpdateEntitySchema, handler: wf.createOrUpdateEntity, desc: 'Create or update a Schema v1 entity', annotations: { idempotentHint: true, openWorldHint: false } },
  ...
  update_hub:            { schema: wf.UpdateHubSchema,            handler: wf.updateHub,            desc: 'Create or update a Schema v1 hub', annotations: { idempotentHint: true, openWorldHint: false } },
  upsert_runbook:        { schema: wf.UpsertRunbookSchema,        handler: wf.upsertRunbook,        desc: 'Create or update a Schema v1 runbook', annotations: { idempotentHint: true, openWorldHint: false } },
  upsert_hub:            { schema: wf.UpsertHubSchema,            handler: wf.upsertHub,            desc: 'Deprecated: use update_hub', annotations: { idempotentHint: true, openWorldHint: false } },
