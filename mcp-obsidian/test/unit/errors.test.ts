...
describe('McpError', () => {
  ...
  it('ErrorCode enum includes all spec codes', () => {
    const codes: ErrorCode[] = [
      ...
      'LEGACY_NAMESPACE_REMOVED', 'DEPRECATED_TOOL', 'ROUTING_VIOLATION',
      'PROTECTED_FIELD_VIOLATION', 'INVALID_SCHEMA_V1', 'TRUST_POLICY_VIOLATION',
      ...
      'INVALID_RELATIVE_TIME', 'UPSERT_HUB_INVALID',
    ];
